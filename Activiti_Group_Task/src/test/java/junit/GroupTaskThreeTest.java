...
/*
 * 使用org.activiti.engine.delegate.TaskListener接口 来指定组任务的办理人。
 * 
 * 启动流程实例时，自动调用该接口的方法来设置组任务的办理人。
 */
public class GroupTaskThreeTest {
	...
	public void testStartProcessInstance(){
		...
		String processDefinitionKey = "groupTaskThree";
	...
	public void testFindGroupTask(){
		...
		/* 孙悟空,猪八戒,唐三藏   随便哪一个都可以查询到 */
		String groupName = "唐三藏";
	...
	public void findHistoryGroupCandidate(){
		...
		List<HistoricIdentityLink> lists = processEngine
										.getHistoryService()
										.getHistoricIdentityLinksForProcessInstance("162501");
										//.getHistoricIdentityLinksForTask("162504");
